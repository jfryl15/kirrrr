...
class ServerSettings(EnvSettings):
    ...
    # Railway injects PORT at runtime. Keep UVICORN_PORT for VPS/Docker installs.
    port: int = Field(default_factory=lambda: int(os.getenv("PORT", "8000")), validation_alias="UVICORN_PORT")
